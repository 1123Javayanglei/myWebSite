...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",0],8,16],".href.split(\"?\").shift().split(\".\").pop();return a})();"]
    },{
      "function":"__u",
      "vtp_component":"URL"
    },{
  ...
  "tags":[{
      ...
      "vtp_enableLinkId":false,
      "vtp_advertisingFeaturesType":"NONE",
      "vtp_eventCategory":"Anchor Link",
      "vtp_eventAction":["template",["macro",4],"Click"],
      "vtp_eventLabel":["macro",5],
      "vtp_enableEcommerce":false,
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      ...
      "vtp_setTrackerName":false,
      "vtp_useDebugVersion":false,
      "vtp_eventCategory":"Link by HTML class",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_enableLinkId":false,
      "vtp_eventAction":["macro",6],
      "vtp_eventLabel":["template",["macro",8]," link [",["macro",9],"] points to ",["macro",10]],
      "vtp_enableEcommerce":false,
      "vtp_trackingId":"UA-301357-1",
      "vtp_enableUaRlsa":false,
      "vtp_enableUseInternalVersion":false,
      ...
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"279369_22",
      "tag_id":20
    },{
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003Ewindow.Optiq={getQueryParam:function(a){a=a.replace(\/[\\[]\/,\"\\\\[\").replace(\/[\\]]\/,\"\\\\]\");a=new RegExp(\"[\\\\?\\x26]\"+a+\"\\x3d([^\\x26#]*)\");a=a.exec(location.search);return null===a?\"\":decodeURIComponent(a[1].replace(\/\\+\/g,\" \"))},sendGETRequest:function(a,b){var c=Object.keys(b).map(function(a){return a+\"\\x3d\"+b[a]});c=\"?\"+c.join(\"\\x26\");return xmlhttp=new XMLHttpRequest,xmlhttp.open(\"GET\",a+c,!0),xmlhttp.send()},sendEvent:function(a){if(!window.Optiq.isReady())return void console.log(\"[iqa]: no query parameters found; exiting.\");\nparams=window.Optiq.params;for(var b in a)params[b]=a[b];window.Optiq.sendGETRequest(\"\/\/platform.rtbiq.com\/events\/\",params)},isReady:function(){return\"\"!==Optiq.params.tr}};window.Optiq.params={tr:window.Optiq.getQueryParam(\"tr\")};\u003C\/script\u003E",
  ...
  "predicates":[{
      ...
      "function":"_re",
      "arg0":["macro",0],
      "arg1":"\\.doc|\\.docx|\\.pdf|\\.ppt|\\.pptx|\\.txt|\\.xls|\\.xlsx|\\.rtf|\\.csv|\\.rar|\\.zip|\\.swf|\\.mp3| \\.mpg|\\.avi|\\.mp4|\\.vsd|\\.vsdx|\\.wav|\\.wmv",
      "ignore_case":true
    },{
      "function":"_eq",
      "arg0":["macro",3],
      ...
      "function":"_cn",
      "arg0":["macro",6],
      "arg1":"figcaption background-caption"
    },{
      "function":"_re",
      "arg0":["macro",7],
      "arg1":"(^$|((^|,)279369_21($|,)))"
      ...
      "function":"_eq",
      "arg0":["macro",11],
      "arg1":"commencement.vassar.edu"
    },{
      "function":"_re",
      "arg0":["macro",2],
      "arg1":"powerhouse\\.vassar\\.edu\\\/.*"
    }],
  "rules":[
    [["if",0,1],["add",0,1]],
    [["if",2,3],["add",2]],
    [["if",3],["unless",4,5],["add",3]],
    [["if",3,6],["add",4]],
    [["if",3,5,7],["add",5]],
    [["if",3,5],["add",6]],
    [["if",1,8],["add",6]],
...
Y.a.jel=["google"],function(){(function(a){Y.__jel=a;Y.__jel.g="jel";Y.__jel.h=!0;Y.__jel.b=0})(function(a){if(!Oh("jel")){var b=K("self"),c=b.onerror;b.onerror=function(d,e,g,h,k){c&&c(d,e,g,h,k);Hh({event:"gtm.pageError","gtm.errorMessage":d,"gtm.errorUrl":e,"gtm.errorLineNumber":g});return!1};Ph("jel")}z(a.vtp_gtmOnSuccess)})}();
